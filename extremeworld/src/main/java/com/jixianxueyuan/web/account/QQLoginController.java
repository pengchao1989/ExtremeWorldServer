package com.jixianxueyuan.web.account;
...
import com.jixianxueyuan.service.account.AccountService;
...
@Controller
@RequestMapping(value = "login/qqlogin")
public class QQLoginController
{
	...
	private com.jixianxueyuan.entity.User myUser = null;
...
//                做一些数据统计工作
            ...
            else 
            {
                ...
                if(myUser == null)
                {
                	...
                	myUser = new com.jixianxueyuan.entity.User();
					...
					com.jixianxueyuan.entity.User inviter = new com.jixianxueyuan.entity.User();
...
/*                Subject subject = SecurityUtils.getSubject();
                ...
                subject.login(token);*/
                Authentication token = myAuthenticationProvider.authenticate(new UsernamePasswordAuthenticationToken(openID,openID));
